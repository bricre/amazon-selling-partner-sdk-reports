# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Reports
...
```shell
composer require bricre/amazon-selling-partner-sdk-reports
```
